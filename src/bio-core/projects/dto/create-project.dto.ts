...
// ─── Sub-DTOs (espejan los sub-schemas de SamplingPlot) ──────────────────────
...
export class CreateProjectDto {
    ...
    /** Métricas globales del muestreo (calculadas por el análisis) */
    @IsOptional()
    @ValidateNested()
